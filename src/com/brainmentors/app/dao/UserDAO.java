...
import static com.brainstuds.utils.CommonDAO.getConnection;
...
import com.brainmentors.app.dto.RightDTO;
import com.brainmentors.app.dto.UserDTO;
import com.brainstuds.utils.QueryConstants;
...
public class UserDAO {
	...
	public String doRegister(String userid, String password)throws ClassNotFoundException, SQLException{
		...
		logger.debug("Inside User Dao after Creating Connection.."+userid);
	...
	public UserDTO doLogin(String userid, String password) throws SQLException, ClassNotFoundException{
		...
		try{
			connection =getConnection();
			logger.debug("Inside UserDAO After Creating Connection..");
